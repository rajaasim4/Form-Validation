<?php 
 ...
 echo "<!DOCTYPE html>\n<html><head><title>Roll No 37 & Roll No Self 48</title>";
 if ($fail == "")
 {
...
402 | Chapter 17: JavaScript and PHP Validation and Error Handling
 ...
 in your form: <p><font color=red size=5><i>$fail</i></font></p>
 </td></tr>
 <form method="post" action="Form_Validation.php" onSubmit="return validate(this)">
 <tr><td>Forename</td>
...
_END;
 ...
 {
 if (ini_set('magic_quotes_runtime', 0)) $string = stripslashes($string);
